...
var GF = function() {
  ...
  var ladrillos = [
    ...
    var createBricks = function(){
        for (var i = ladrillos.length - 1; i >= 0; i--) {
            ...
            bricks[i] = new Brick(ladrillo.x, ladrillo.y, ladrillo.c);
        }
  ...
  function updateBalls() {
    for (var i = balls.length - 1; i >= 0; i--) {
        ...
        //pendiente borrar circRectsOverlap
  ...
  var mainLoop = function(time) {
    ...
    var bola = new Ball(10, 25, 2*Math.PI, 10, 6, false);       // bola horizontal
    balls.push(bola);
    var bola = new Ball(w/2, h/2, Math.PI/2, 10, 6, false);     // bola vertical
    balls.push(bola);
    var bola = new Ball(w/3, h/2, Math.PI/2, 40, 6, false);     // bola vertical 2
    balls.push(bola);
    var bola = new Ball(w/3, h/2, Math.PI/4, 10, 6, false);     // bola diagonal
    balls.push(bola);
    var bola = new Ball(w*3/4, h/2, Math.PI*3/4, 20, 6, false);     // bola diagonal
    balls.push(bola);
